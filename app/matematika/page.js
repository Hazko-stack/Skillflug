...
export default function MatematikaPage() {
  ...
  return (
    ...
    >
      <h1 className="text-3xl mb-6 text-white mt-28 md:mt-32">Matematika Materi</h1>
      ...
      <div className="mb-6">
        ...
        >
          <option value="Matematika1">Matematika 1</option>
          <option value="Matematika2">matematika 2</option>
          <option value="Matematika3">Matematika 3</option>
          <option value="Matematika4">Matematika 4</option>
        </select>
      </div>
