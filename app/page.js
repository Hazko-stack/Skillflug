...
export default function Home() {
  return (
    ...
    >
      ...
      <div className="hidden sm:block absolute bottom-32 left-10 text-left text-violet-600 font-bold">
