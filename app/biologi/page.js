...
export default function BiologiPage() {
  ...
  const [selectedChapter, setSelectedChapter] = useState('Biologi1');
  ...
  return (
    ...
    >
      <h1 className="text-3xl mb-6 text-white mt-28 md:mt-32">Biologi Materi</h1>
      ...
      <div className="mb-6">
        ...
        >
          <option value="Biologi1">Biologi 1</option>
          <option value="Biologi2">Biologi 2</option>
          <option value="Biologi3">Biologi 3</option>
          <option value="Biologi4">Biologi 4</option>
        </select>
      </div>
